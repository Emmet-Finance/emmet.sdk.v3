...
export declare class WrappedJetton implements Contract {
    static init(owner: Address, jetton_content: Cell): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(owner: Address, jetton_content: Cell): Promise<WrappedJetton>;
    ...
    }, message: JettonBurnNotification | JettonMint | Deploy): Promise<void>;
