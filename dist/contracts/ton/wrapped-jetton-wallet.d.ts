...
export declare class WrappedJettonWallet implements Contract {
    ...
    static fromInit(owner: Address, jetton_master: Address): Promise<WrappedJettonWallet>;
    static fromAddress(address: Address): WrappedJettonWallet;
    ...
    }, message: JettonTransfer | JettonBurn | JettonInternalTransfer): Promise<void>;
...
//# sourceMappingURL=wrapped-jetton-wallet.d.ts.map