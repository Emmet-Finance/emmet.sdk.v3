...
export declare const LPWallet_getterMapping: {
    [key: string]: string;
};
export declare class LPWallet implements Contract {
    static init(owner: Address, master: Address): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(owner: Address, master: Address): Promise<LPWallet>;
    static fromAddress(address: Address): LPWallet;
    ...
    }, message: null | TokenTransfer | TokenTransferInternal | TokenBurn): Promise<void>;
...
//# sourceMappingURL=tact_LPWallet.d.ts.map