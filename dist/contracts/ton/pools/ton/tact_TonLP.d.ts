...
export declare function storeTonLP$Data(src: TonLP$Data): (builder: Builder) => void;
export declare function loadTonLP$Data(slice: Slice): {
    $$type: "TonLP$Data";
    admin: Address;
    available_underlying: bigint;
    bridge: Address;
...
export declare const TonLP_getterMapping: {
    [key: string]: string;
};
export declare class TonLP implements Contract {
    static init(admin: Address, cfo: Address, bridge: Address, decimals: bigint, protocolFee: bigint, tokenFee: bigint, content: Cell): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(admin: Address, cfo: Address, bridge: Address, decimals: bigint, protocolFee: bigint, tokenFee: bigint, content: Cell): Promise<TonLP>;
    static fromAddress(address: Address): TonLP;
    ...
    }, message: null | Deposit | ReleaseTokens | TokenBurnNotification | WithdrawRewards | UpdateDeposits | Withdraw | SetAdmin | SetCFO | SetBridge | SetWalletAddress | UpdateFees | UpdateGasCost | Deploy | TokenUpdateContent | ProvideWalletAddress | GrantRole | RevokeRole | RenounceRole | UpdateRoleAdmin): Promise<void>;
...
//# sourceMappingURL=tact_TonLP.d.ts.map