...
export declare class EmmetJettonLPWallet implements Contract {
    static init(owner: Address, jetton_master: Address): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(owner: Address, jetton_master: Address): Promise<EmmetJettonLPWallet>;
    static fromAddress(address: Address): EmmetJettonLPWallet;
...
//# sourceMappingURL=tact_EmmetJettonLPWallet.d.ts.map