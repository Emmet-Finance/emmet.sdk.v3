...
async function WrappedJetton_init(owner: Address, jetton_content: Cell) {
...
export class WrappedJetton implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: JettonBurnNotification | JettonMint | Deploy) {
