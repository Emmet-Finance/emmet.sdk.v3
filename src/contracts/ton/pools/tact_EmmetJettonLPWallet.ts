...
function dictValueParserRewardsPaid(): DictionaryValue<RewardsPaid> {
 ...
 type EmmetJettonLPWallet_init_args = {
    $$type: 'EmmetJettonLPWallet_init_args';
    owner: Address;
    jetton_master: Address;
}

function initEmmetJettonLPWallet_init_args(src: EmmetJettonLPWallet_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.owner);
...
async function EmmetJettonLPWallet_init(owner: Address, jetton_master: Address) {
...
const EmmetJettonLPWallet_errors: { [key: number]: { message: string } } = {
...
const EmmetJettonLPWallet_types: ABIType[] = [
...
const EmmetJettonLPWallet_getters: ABIGetter[] = [
...
const EmmetJettonLPWallet_receivers: ABIReceiver[] = [
...
export class EmmetJettonLPWallet implements Contract {
