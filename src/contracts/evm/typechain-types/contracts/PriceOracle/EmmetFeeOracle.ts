...
export declare namespace IEmmetFeeOracle {
  ...
  export type ChainStructOutput = [
    ...
    txFee: bigint,
    nativeCoin: string
  ] & { chainId: bigint; domain: bigint; txFee: bigint; nativeCoin: string };

  export type CoinFeeStruct = {
    minimum: BigNumberish;
    percentage: BigNumberish;
  };

  export type CoinFeeStructOutput = [minimum: bigint, percentage: bigint] & {
    minimum: bigint;
    percentage: bigint;
  };
}
...
export interface EmmetFeeOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "updateChain"
      | "updateCoinFee"
      | "updateProtocolFeeDivisor"
      | "updateTxMinimalFee"
  ): FunctionFragment;

  getEvent(
    nameOrSignatureOrTopic: "AdminChanged" | "MinimalFeeChanged"
  ): EventFragment;

  encodeFunctionData(
    functionFragment: "calculateCoinFees",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "calculateTransactionFee",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "getChainByname",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "getChainFee",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getChainNameByDomain",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getChainNameById",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "getCoinFee", values: [string]): string;
  encodeFunctionData(
    functionFragment: "getCoinPrice",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "protocolFeeDivisor",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateCoinFee",
    values: [string, IEmmetFeeOracle.CoinFeeStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "updateProtocolFeeDivisor",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "updateTxMinimalFee",
    values: [BigNumberish]
  ): string;
...
export namespace MinimalFeeChangedEvent {
...
export interface EmmetFeeOracle extends BaseContract {
  ...
  calculateCoinFees: TypedContractMethod<
    [coinName_: string, amount_: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  updateCoinFee: TypedContractMethod<
    [coinName_: string, coinFee_: IEmmetFeeOracle.CoinFeeStruct],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "calculateCoinFees"
  ): TypedContractMethod<
    [coinName_: string, amount_: BigNumberish],
    [bigint],
    "view"
  >;
  getFunction(
    nameOrSignature: "calculateTransactionFee"
  ): TypedContractMethod<[destChainName_: string], [bigint], "view">;
  getFunction(
    nameOrSignature: "getChainByname"
  ): TypedContractMethod<
    [chainName_: string],
    [IEmmetFeeOracle.ChainStructOutput],
    "view"
  >;
  getFunction(
    nameOrSignature: "getChainFee"
  ): TypedContractMethod<[destDomain_: BigNumberish], [bigint], "view">;
  getFunction(
    nameOrSignature: "getChainNameByDomain"
  ): TypedContractMethod<[destDomain_: BigNumberish], [string], "view">;
  getFunction(
    nameOrSignature: "getChainNameById"
  ): TypedContractMethod<[chainId_: BigNumberish], [string], "view">;
  getFunction(
    nameOrSignature: "getCoinFee"
  ): TypedContractMethod<
    [coinName_: string],
    [IEmmetFeeOracle.CoinFeeStructOutput],
    "view"
  >;
  getFunction(
    nameOrSignature: "getCoinPrice"
  ): TypedContractMethod<[coinName: string], [bigint], "view">;
  getFunction(
    nameOrSignature: "priceOracle"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "protocolFeeDivisor"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "selfChainId"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "selfCoin"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "updateProtocolFeeDivisor"
  ): TypedContractMethod<
    [protocolFeeDivisor_: BigNumberish],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "updateTxMinimalFee"
  ): TypedContractMethod<[txMinimumFee_: BigNumberish], [void], "nonpayable">;
  ...
  >;
  getEvent(
    key: "MinimalFeeChanged"
  ): TypedContractEvent<
    MinimalFeeChangedEvent.InputTuple,
    MinimalFeeChangedEvent.OutputTuple,
    MinimalFeeChangedEvent.OutputObject
  >;
  ...
  filters: {
    ...
    "MinimalFeeChanged(uint256)": TypedContractEvent<
      MinimalFeeChangedEvent.InputTuple,
      MinimalFeeChangedEvent.OutputTuple,
      MinimalFeeChangedEvent.OutputObject
    >;
    MinimalFeeChanged: TypedContractEvent<
      MinimalFeeChangedEvent.InputTuple,
      MinimalFeeChangedEvent.OutputTuple,
      MinimalFeeChangedEvent.OutputObject
    >;
